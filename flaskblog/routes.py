...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash('Your account has been created! You are now able to log in', 'success') # flash : add a new item
        return redirect(url_for('login')) # redirect : redirect to another page
...
def user_posts(username):
    ...
    return render_template('user_post.html', posts=posts, user=user) # transfer here posts to the html's posts
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Your password has been update! You are now able to log in', 'success') # flash : add a new item
        return redirect(url_for('login')) # redirect : redirect to another page
